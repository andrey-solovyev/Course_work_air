...
@Controller
@Scope("prototype")
public class CreatePassengerNameRecordWrapper extends GenericRequestWrapper<CreatePassengerNameRecordRQ, CreatePassengerNameRecordRS> {

    @Autowired
    @Qualifier("createPassengerNameRecordComposingCallback")
    ...
    protected Jaxb2Marshaller marshaller() {
        ...
        marshaller.setContextPath("org.example.contractAir.createpassengernamerecord");
        return marshaller;
    }

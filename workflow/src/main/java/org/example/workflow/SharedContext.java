 ...
 * whether there was a fault during the org.example.workflow execution and also defines how
 * many times should the org.example.workflow be rerun in case of a failure; implements the
...
public class SharedContext implements Visitable {
     ...
     * 
     * @return the org.example.workflow object.
     */
